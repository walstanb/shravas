...
class engine():
	...
	def __init__(self):
		...
		rospy.Subscriber('wp_x_temp',Int32,self.get_coordinate_x)
		rospy.Subscriber('wp_y_temp',Int32,self.get_coordinate_y)
		rospy.Subscriber('wp_z_temp',Int32,self.get_coordinate_z)
...
#SUBSCRIBER FUNCTIONS
	...
	def get_coordinate_x(self,wpx):
		self.wp_x = wp.x
		print(self.wp_x)

	def get_coordinate_y(self,wpy):
		self.wp_y = wp.y
		print(self.wp_y)

	def get_coordinate_z(self,wpz):
		self.wp_z = wp.z
		print(self.wp_z)

...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Scale = ttk.Scale(self.XYPositionalDataFrame, from_=0, to=1.0)
        ...
        self.XYPositionalData = tk.Canvas(self.XYPositionalDataFrame, height=515, width=915)
        ...
        self.XYPositionalData.grid(row=0, column=0, sticky="nsew")
        ...
        photo_location = os.path.join(prog_location,"/home/krut/devel/dmode.png")
        global _img1
        _img1 = tk.PhotoImage(file=photo_location)
        self.dmodeButton.configure(image=_img1)

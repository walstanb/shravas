...
drobj = rospy.Publisher('/drone_init', Int32, queue_size=1, latch=True)
def start():
    drobj.publish(1)
def emstop():
    drobj.publish(0)
...
class Gui():
    ...
    def __init__(self,obj=None):
        ...
        Lphoto = PIL.ImageTk.PhotoImage(PIL.Image.open("/home/krut/devel/logoba.jpeg").resize((200, 50), PIL.Image.ANTIALIAS))
        top.Logo.configure(image = Lphoto)
        top.Logo.image = Lphoto

        Cphoto = PIL.ImageTk.PhotoImage(PIL.Image.open("/home/krut/devel/credits.png").resize((857, 408), PIL.Image.ANTIALIAS))
        top.CreditsSlide.configure(image = Cphoto)
        top.CreditsSlide.image = Cphoto

        Aphoto = PIL.ImageTk.PhotoImage(PIL.Image.open("/home/krut/devel/about.png").resize((857, 408), PIL.Image.ANTIALIAS))
